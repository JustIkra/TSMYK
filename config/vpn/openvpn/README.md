# OpenVPN Configuration (Legacy)

> **Note**: OpenVPN is now legacy. We recommend using **Hysteria2** for better performance and easier setup.
> See [Hysteria2 documentation](../hysteria2/README.md) for migration instructions.
