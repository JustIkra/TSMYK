...
Supports WireGuard, AWG (AmneziaWG), OpenVPN, and Hysteria2.
"""
...
class Hysteria2Status(BaseModel):
    """Hysteria2 proxy status information."""

    server: str | None = None
    socks5_port: int
    http_port: int
    is_running: bool
    socks5_accessible: bool
...
class VpnHealthResponse(BaseModel):
    ...
    wireguard: WireGuardOverview | None = None
    hysteria2: Hysteria2Status | None = None
